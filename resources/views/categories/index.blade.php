                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Category Search</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                      	<!-- LOOPING DATA Category SESUAI JUMLAH DATA YANG ADA DI VARIABLE $CATEGORY -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form onsubmit="return confirm('Yakin Edit Category ?')" action="{{ route('categories.destroy', $cat->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
